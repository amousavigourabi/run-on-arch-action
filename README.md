...
A GitHub Action that allows executing commands on a variety of CPU architectures (armv6, armv7, aarch64, s390x, ppc64le, x86) via QEMU.

## Usage

This action requires three input parameters:

* `arch`: CPU architecture: `armv6`, `armv7`, `aarch64`, `riscv64`, `s390x`, `ppc64le`, or `x86`. See [Supported Platforms](#supported-platforms) for the full matrix.
